...
const localDeliveryList = linkList.filter((item) => item.category === 'local_delivery');
const localPickupList = linkList.filter((item) => item.category === 'local_pickup');
const customerList = linkList.filter((item) => item.category === 'customer');
const emailMarketingList = linkList.filter((item) => item.category === 'email_marketing');
const returnsList = linkList.filter((item) => item.category === 'returns');
const staffOrderNotificationsList = linkList.filter((item) => item.category === 'staff_order_notifications');
const listObject = {
